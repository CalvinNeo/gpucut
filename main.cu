...
int main(){
	...
	uint* vcount_poly = new uint[poly_count];
	ufloat* poly_vertexs = new ufloat[polyvertex_count*2];
	ufloat* circles = new ufloat[circle_count*3];
	ufloat* lines = new ufloat[line_count*4];
